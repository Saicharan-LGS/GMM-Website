...
const basicDoubtsQuestionAnswerList=[
    ...
    {id:6,question:"What is the duration of the courses Glorious Mindmine offers?",answer:"The Full Stack courses that Glorious Mindmine offers has a flexible duration. It can be completed between 1-12 months depending upon your commitment and prior knowledge of data science and web development concepts. For example, if you have already done some courses and are confident about your knowledge, you can directly attempt the competency tests. But if you are new to these fields, it may take 8-12 months for mastering all the concepts to become job-ready.",category:"Learning"},
    ...
    {id:17,question:"How will Glorious Mindmine verify my income?",answer:"As per the ISA, you will be legally bound to furnish all the income relevant documents such as Offer Letter, Salary Slips, Income Tax Returns, Bank Statements, etc. to AlmaBetter.",category:"PayAfterPlacement"},
    ...
    {id:20,question:"When will the placement process start?",answer:"Once you clear the Foundation Track you will earn a certificate of completion. Post that you will be eligible to participate in our placement drive called Glorious Mindmine.",category:"Placements"},

...
const basicDoubtsQuestionAnswerList=[
    {id:1,question:"Who can enroll in GloriousMindMine's courses?",answer:"GloriousMindMine's courses are open to anyone willing to learn Data Science or Web Development. There is no limitation with respect to your educational background or stage of study. The courses are especially beneficial for people who have jobs or other commitments and therefore want to learn Data Science or Web Development from scratch at their own pace. Also, if you have already done some courses and want our placement services, you can enroll in any of the two courses and be eligible for placements just after clearing the competency tests. To summarise, the courses are suitable for everyone, whether you are a beginner with no coding background or you have done some courses in either Data Science or Web Development.",category:"Admissions"},
    {id:2,question:"What is a Cohort?",answer:"A cohort is just another term used for a batch.",category:"Admissions"},
    {id:3,question:"Is there any selection test for enroling in GloriousMindMine's courses?",answer:"No, you don't have to take any test to enrol in the Full Stack courses that we offer.",category:"Admissions"},
    {id:4,question:"Is it mandatory to opt for the GloriousMindMine Career Track?",answer:"No, it is not mandatory to opt for GloriousMindMine Career Track. However, we strongly recommend opting for GloriousMindMine Career Track in order to get placed amongst our 700+ hiring partners.",category:"Admissions"},
    ...
    {id:6,question:"What is the duration of the courses GloriousMindMine offers?",answer:"The Full Stack courses that GloriousMindMine offers has a flexible duration. It can be completed between 1-12 months depending upon your commitment and prior knowledge of data science and web development concepts. For example, if you have already done some courses and are confident about your knowledge, you can directly attempt the competency tests. But if you are new to these fields, it may take 8-12 months for mastering all the concepts to become job-ready.",category:"Learning"},
    ...
    {id:17,question:"How will GloriousMindMine verify my income?",answer:"As per the ISA, you will be legally bound to furnish all the income relevant documents such as Offer Letter, Salary Slips, Income Tax Returns, Bank Statements, etc. to AlmaBetter.",category:"PayAfterPlacement"},
    ...
    {id:20,question:"When will the placement process start?",answer:"Once you clear the Foundation Track you will earn a certificate of completion. Post that you will be eligible to participate in our placement drive called GloriousMindMine.",category:"Placements"},
...
class FullStackCourse extends Component{

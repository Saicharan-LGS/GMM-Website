...
import profile from "../../../Images/venuprofile.jpg"
class Intro extends Component{
    render(){
        return(
            <div className="course-intro-main-container">
                <div className="course-intro-sub-container">
                    <h1 className="course-Intro-Heading">Certification In Mendix</h1>
                    ...
                    <div className='course-intro-list-container'>
                        ...
                        <span className='course-intro-list-text'>2 months part-time program with live offline classes</span>
                    </div>
                    <div className='course-intro-list-container'>
                        <IoMdCheckmarkCircle className='course-intro-list-icon'/>
                ...
                <div className="course-side-image-main-container">
                    ...
                    <p className="course-intro-data-analyst">Venu</p>
                    <div className="course-intro-side-image-desc">
                        ...
                        <p className="course-intro-data-analyst">Mendix Developer</p>
                    </div>
                </div>
            </div>
        ) 

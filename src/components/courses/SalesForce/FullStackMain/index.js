...
const ScrolllingImages1 = [
  ...
  const tuitionFeeList=[
    "Fundamentals of SalesForce with Specialisation Track","Placement Track offering guaranteed job above 5 LPA","100+ Live Classes and real time doubt resolution",
